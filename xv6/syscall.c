...
extern uint64 sys_schedtrace_reset(void);
extern uint64 sys_schedtrace_dump(void);
...
static uint64 (*syscalls[])(void) = {
  ...
  [SYS_schedtrace_reset] = sys_schedtrace_reset,
  [SYS_schedtrace_dump] = sys_schedtrace_dump,
  // clang-format on
};
